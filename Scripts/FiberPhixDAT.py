...
#Create a class for gathering, detrending, and fitting stream data.
class StreamData():
...
#Main loop
def main():
	#Create your signal stream object ---> detrend and fit
	...
	#Create your control stream object ---> detrend and fit
	...
	#Combine your two stream objects (detrended/fitted) ---> delta f/f
	...
	#Plot 4 graphs (raw signals, scaled signals, % change, z-score)
	...
	fig.tight_layout()
	plt.savefig('PATH TO FOLDER FOR FIGURE STORAGE' + '.png',dpi = 600) #Update with a save file location!
